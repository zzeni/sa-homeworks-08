...
`;
  ...
  function onSearchInput(event) {
    ...
    var filterBikes = bikes.filter(function (bike) {
      var search = bike.title + " " + bike.description;
      return search.toLowerCase().includes(value);
    });

    displayBikes(filterBikes);
  }

  $("#search").on("keyup", onSearchInput);
